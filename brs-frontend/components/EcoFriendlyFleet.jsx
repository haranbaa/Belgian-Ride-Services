...
const vehicles = [
  {
    name: "Hybrid Vehicle",
    description:
      "A modern hybrid car designed to reduce emissions while maintaining luxury and reliability.",
    image: "/Mercedes-Benz .jpg",
  },
  {
    name: "VW ID.5",
    description:
      "The cutting-edge VW ID.5 offers zero-emission travel with luxury and efficiency.",
    image: "/Volkswagen-ID5-.jpg",
  },
  {
    name: "MG5 Electric",
    description:
      "The MG5 offers an all-electric experience with sleek design and exceptional performance.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            At Belgian Ride Services, we're committed to reducing our
            environmental impact with our eco-friendly fleet. Experience the
            future of sustainable travel today.
          </p>
        </div>
