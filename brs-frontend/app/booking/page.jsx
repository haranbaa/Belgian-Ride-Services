...
const BookingPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      emailjs
        .send(
          "service_0unv8y6", // Replace with your EmailJS Service ID
          isDelivery ? "template_qr8fgml" : "template_tth1hkg", // Replace with the appropriate Template ID
          emailData,
          "YHQnPqRng7qbYSGb1" // Replace with your EmailJS Public Key
        )
        .then(
          (result) => {
